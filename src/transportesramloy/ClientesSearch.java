 ...
 */
public class ClientesSearch extends javax.swing.JInternalFrame {
        ...
        tableClientes.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evnt) {
                if (evnt.getClickCount() == 2) {
                    int selected = Integer.parseInt(tableClientes.getValueAt(tableClientes.getSelectedRow(), 0).toString());
                    ClientesDialog.cliente_id = selected;

                    ClientesDialog clientes_dialog = new ClientesDialog(null, rootPaneCheckingEnabled);
                    clientes_dialog.setTitle("CLIENTE NO. " + selected);
                    clientes_dialog.setVisible(true);
                    clientes_dialog.toFront();
                }
            }
        });
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(548, 332));
        ...
        tableClientes.setSelectionBackground(new java.awt.Color(128, 0, 0));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        clientes.ClientesBuscar(tableClientes, cadena);
